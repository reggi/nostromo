import { NodeFileSystemAdatptor, NodeJwtSerDe, NodeWsAdaptor } from "@liveviewjs/express";
...
export class AstroLiveViewServer
  ...
  httpMiddleware(): RequestHandler {
    return async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        // console.log("matchResult", matchResult, getRequestPath())
        if (!matchResult) {
